...
runAnalysis: ${TMP_DIR}/runAnalysis.o ${TMP_DIR}/Event.o ${TMP_DIR}/EventSet.o ${TMP_DIR}/EventCut.o ${TMP_DIR}/Track.o ${TMP_DIR}/TrackCut.o ${TMP_DIR}/Jet.o ${TMP_DIR}/JetCut.o ${TMP_DIR}/HistSet.o ${TMP_DIR}/Lepton.o ${TMP_DIR}/LeptonCut.o ${TMP_DIR}/Point.o ${TMP_DIR}/FitterConfig.o ${TMP_DIR}/PointsProcessor.o ${TMP_DIR}/Helix.o
	$(CC) $^ -o $@ $(LDFLAGS)
...
scanCuts: ${TMP_DIR}/scanCuts.o ${TMP_DIR}/Event.o ${TMP_DIR}/EventSet.o ${TMP_DIR}/EventCut.o ${TMP_DIR}/Track.o ${TMP_DIR}/TrackCut.o ${TMP_DIR}/Jet.o ${TMP_DIR}/JetCut.o ${TMP_DIR}/HistSet.o ${TMP_DIR}/Lepton.o ${TMP_DIR}/LeptonCut.o ${TMP_DIR}/Point.o ${TMP_DIR}/Point.o ${TMP_DIR}/FitterConfig.o ${TMP_DIR}/PointsProcessor.o ${TMP_DIR}/Helix.o
	$(CC) $^ -o $@ $(LDFLAGS)
