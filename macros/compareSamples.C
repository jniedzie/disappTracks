...
//  hist name                       pad x axis title                                  canvas maxY rebin
  ...
  { "chargino_n_layers_gen"       , {6, "#chi^{#pm} N_{layers}^{gen}"                 , 0, 0.15, 1 } },
  ...
  { "tracker_cluster_charge_TOB"  , {4, "Charge deposit in TOB (ADC counts)"          , 2, 0.05, 1 } },
  { "pion_cluster_charge_TOB"     , {4, "Charge deposit in TOB (ADC counts)"          , 2, 0.05, 2 } },
