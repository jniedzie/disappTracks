...
double_hit_max_distance:            

### Constraints on seeds parameters:
seed_max_chi2:                            

seed_middle_hit_min_delta_phi:   
seed_middle_hit_max_delta_phi:  
seed_middle_hit_max_delta_z:     

seed_last_hit_min_delta_phi:       
seed_last_hit_max_delta_phi:      
seed_last_hit_max_delta_z:         

### Constrains on pion track parameters:
track_max_chi2:                           

next_point_min_delta_phi:           
