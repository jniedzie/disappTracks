...
//    "../data_andrea/MC-SR/QCD_HT100to200/",
    ...
    "../data_andrea/MC-SR/QCD_HT700to1000/",
    "../data_andrea/MC-SR/QCD_HT1000to1500/",
    "../data_andrea/MC-SR/QCD_HT1500to2000/",
    "../data_andrea/MC-SR/QCD_HT2000toInf/",
  },
  // DY + jets (Z->μμ)
  {
    "../data_andrea/MC-SR/DYJetsM50_HT100to200/",
    "../data_andrea/MC-SR/DYJetsM50_HT100to200e/",
    "../data_andrea/MC-SR/DYJetsM50_HT200to400/",
    "../data_andrea/MC-SR/DYJetsM50_HT200to400e/",
    "../data_andrea/MC-SR/DYJetsM50_HT400to600/",
    "../data_andrea/MC-SR/DYJetsM50_HT400to600e/",
    "../data_andrea/MC-SR/DYJetsM50_HT600to800/",
    "../data_andrea/MC-SR/DYJetsM50_HT800to1200/",
    "../data_andrea/MC-SR/DYJetsM50_HT1200to2500/",
    "../data_andrea/MC-SR/DYJetsM50_HT2500toInf/",
  },
  // tops
  {
...
//    "../data_andrea/MC-SR/TBar_tch/",
  ...
  // VV
  {
    "../data_andrea/MC-SR/WW/",
    "../data_andrea/MC-SR/WZ/",
    "../data_andrea/MC-SR/ZZ/",
  },
  // W->μν + jets
  {
