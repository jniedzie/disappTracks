...
const map<EVar, tuple<string, int, double, double>> settings =
{
  ...
  {kTrackCaloEm , {"EM calo energy",50,0,10}},
  {kTrackCaloHad , {"Hadron calo energy",50,0,10}},
  ...
  {kTrackRelativeIsolation , {"Relative isolation in dR=0.3",50,0,1}},
  {kTrackAbsoluteIsolation , {"Absolute isolation in dR=0.3",50,0,1}},
